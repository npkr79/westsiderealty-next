...
export default function RegisterPage() {
  ...
  const previewSrc = profileImage ? URL.createObjectURL(profileImage) : fallbackImage;
      ...
      <div className="container mx-auto max-w-2xl">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Create your agent profile to start listing properties</CardDescription>
          </CardHeader>
          <CardContent>
