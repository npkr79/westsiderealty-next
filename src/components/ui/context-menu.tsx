...
/**
 * Lightweight context-menu component stubs.
 * These are placeholders until @radix-ui/react-context-menu is installed.
 * The context-menu component is not currently used in the codebase.
 */
