...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Privacy Policy for RE/MAX Westside Realty - Learn how we collect, use, and protect your personal information.",
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-lg text-gray-700 mb-8">
            ...
            visitors and clients. This Privacy Policy outlines how we collect, use, and protect your personal
            information when you visit or interact with our website:{" "}
            <strong>
              <a href="https://www.westsiderealty.in" className="text-remax-red hover:underline">
                www.westsiderealty.in
              </a>
            </strong>
            .
          </p>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  <strong>Personal Information</strong>: Name, phone number, email address, and other contact
                  details submitted through inquiry or contact forms.
                </li>
                <li>
                  <strong>Property Preferences</strong>: Details you provide related to your property search,
                  including budget, location preferences, etc.
                </li>
                <li>
                  <strong>Usage Data</strong>: Information automatically collected through analytics tools such as
                  IP address, device type, browser, time spent on site, and pages visited.
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 mb-4">
                We <strong>do not sell, trade, or rent</strong> your personal information. We may share your
                details with:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>
                  Service providers helping us operate the website or CRM tools (under confidentiality
                  obligations)
                </li>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  Opt-out of receiving marketing communications by clicking "unsubscribe" in emails or notifying us
                  directly
                </li>
                <li>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700">
                We take reasonable precautions to protect your information. However, no method of transmission over
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700">
                We may update this policy from time to time. All changes will be posted on this page with an updated
                revision date.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 mb-4">
                If you have any questions about this Privacy Policy or need to exercise your data rights, please
                contact us:
              </p>
