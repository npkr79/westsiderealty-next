    ...
    <div style={{ padding: 40 }}>
      ...
      <div style={{ marginTop: 20 }}>
        <div>
          ...
          {(data.rera_project as any)?.project_name ?? "Not disclosed"}
        </div>
        <div>
          <strong>RERA ID:</strong>{" "}
          {(data.rera_project as any)?.id ?? "Not disclosed"}
        </div>
        <div>
          <strong>city_slug:</strong>{" "}
          {(data.rera_project as any)?.city_slug ?? "Not disclosed"}
        </div>
        <div>
          <strong>url_slug:</strong>{" "}
          {(data.rera_project as any)?.url_slug ?? "Not disclosed"}
        </div>
      </div>
